...
Now, connect to this database like we did in the previous tutorial 
...
We can also query the addresses for a particular user given a `Text` with the email address the `UserId` contains.
