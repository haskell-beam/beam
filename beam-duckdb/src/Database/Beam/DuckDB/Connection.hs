...
-- | Internal module providing the 'DuckDBM' monad and core 'MonadBeam'
-- instances for the DuckDB backend. Re-exported from "Database.Beam.DuckDB".
module Database.Beam.DuckDB.Connection
  ( DuckDBM (..),
    runBeamDuckDB,
    runBeamDuckDBDebug,
