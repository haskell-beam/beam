...
class
  ( -- Every SQL backend must be a beam backend
    BeamBackend be
...
type BeamSql2003ExpressionBackend be =
  ( IsSql2003ExpressionSyntax (BeamSqlBackendExpressionSyntax be)
