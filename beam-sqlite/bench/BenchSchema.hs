...
-- | Shared schema used by the @beam-sqlite@ row-reader benchmark.
--
...
-- by hand. This lets us compare the cost of @beam-sqlite@ row
-- reading against the @sqlite-simple@ baseline on the same data.
module BenchSchema
  ( ImdbNameT (..),
    ImdbName,
    ImdbDb (..),
