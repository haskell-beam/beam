...
import Database.Beam.Query (Q, Projectible, SqlBool, buildSqlQuery, allInGroup_)
import Database.Beam.Query.Internal (QExpr, QAgg, QGenExpr(..))
...
-- | SQL @CONCAT@ function
concat_ :: [ QGenExpr context s T.Text ] -> QGenExpr context s T.Text
